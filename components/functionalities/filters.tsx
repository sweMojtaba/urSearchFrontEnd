...
// In the future: we need to move the state up to the page level, so that the advanced filters can be used to filter the results
export function SearchBarWithAdvancedFilters() {
