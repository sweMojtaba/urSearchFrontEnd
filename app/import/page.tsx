...
function Import() {
    ...
    const redirectWhenNotLoggedIn = useRedirectWithUserState(user.state, (userState) => userState === 0, RedirectNotes.LOGGED_OUT, "/login");
    ...
    }, [user.state, redirectWhenNotLoggedIn]);
